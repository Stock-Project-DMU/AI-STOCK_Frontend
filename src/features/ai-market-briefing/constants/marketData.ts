...
export const MARKET_INDEXES = [
    ["코스피", "6,936.99", "+338.12 (5.12%)", "text-emerald-600"],
    ["코스닥", "1,213.74", "+12.40 (1.03%)", "text-emerald-600"],
    ["S&P 500", "7,259.1", "+58.35 (0.81%)", "text-emerald-600"],
    ["나스닥", "28,144.75", "+368.75 (1.32%)", "text-emerald-600"],
    ["USD/KRW", "1,342.50", "-8.20 (0.61%)", "text-blue-500"],
] as const;
