                ...
                <table className="w-full min-w-[720px] border-collapse text-[13px]">
                    <thead>
                        <tr className="border-b border-hairline bg-surface-soft text-[12px] font-bold tracking-wider text-muted">
                            ...
                            <th className="px-3 py-2 text-right">시장 정보</th>
                        </tr>
                    </thead>
                    <tbody>
                        {visibleRows.map((stock, rowIndex) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-3 py-2 text-center" onClick={(event) => event.stopPropagation()}><FavoriteButton size="sm" favorite={authenticated && favoriteCodes.has(stock.code)} disabled={!!pendingCode} onToggle={(nextFavorite) => void handleFavorite(stock.code, nextFavorite)} /></td>
