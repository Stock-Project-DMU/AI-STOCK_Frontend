    ...
    <div className="mx-auto max-w-[1180px]">
      ...
      <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_280px]">
        <section className="rounded-lg border border-hairline bg-surface-soft p-4 sm:p-5">
          ...
          <strong className={`num mt-1.5 block text-2xl font-black sm:text-3xl ${totalProfit >= 0 ? "text-red-500" : "text-blue-500"}`}>{totalProfitText}</strong>
